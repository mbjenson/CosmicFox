...
class TileMapOld : private Tile
{
public:
	TileMapOld();

	TileMapOld(sf::Vector2i _mapSize, int* _tileTypes, int* _logGrid,
			sf::Texture& textureSheet, sf::Vector2u _tileSize);

	TileMapOld(int numTileTypes, Tile* _tilesArr, sf::Vector2i _mapSize, int* _tileTypes, int* _logGrid, sf::Vector2u _tileSize);
